    ...
    <Tooltip.Provider>
      <Tooltip.Root>
        <Tooltip.Trigger>
          <Badge
            variant="secondary"
            class="space-x-2 bg-emerald-100 px-2 py-0.5 text-sm font-medium text-emerald-700 hover:bg-emerald-200 dark:bg-emerald-900/30 dark:text-emerald-300"
          >
            <Star class="h-4 w-4" />
            <span class="hidden xl:inline">Neu hinzugefügt</span>
          </Badge>
        </Tooltip.Trigger>
        <Tooltip.Content>
