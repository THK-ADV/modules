  ...
  <Form.Control>
    {#snippet children({ props })}
      ...
      <Input
        ...
        placeholder="Modulbezeichnung eingeben…"
        class={$errors.title ? 'border-destructive' : ''}
      />
    {/snippet}
  </Form.Control>
  <Form.Description
    >Die Modulbezeichnung wird an vielen Stellen als Bezeichner für das Modul verwendet, wie z.B. im
    Inhaltsverzeichnis des Modulhandbuchs und in den Prüfungslisten. Muss nicht eindeutig sein.</Form.Description
  >
  <Form.FieldErrors />
</Form.Field>
  ...
  <Form.Control>
    {#snippet children({ props })}
      ...
      <Input
        ...
        placeholder="Modulabkürzung eingeben…"
        class={$errors.abbrev ? 'border-destructive' : ''}
      />
    {/snippet}
  </Form.Control>
  <Form.Description
    >Die Modulabkürzung wird im Modulhandbuch und an einigen Stellen anstelle der Modulbezeichnung
    verwendet. Muss nicht eindeutig sein.</Form.Description
  >
  <Form.FieldErrors />
</Form.Field>
  ...
  <Form.Control>
    {#snippet children({ props })}
      ...
      <Input
        ...
        placeholder="ECTS eingeben…"
        class={$errors.ects ? 'border-destructive' : ''}
      />
    {/snippet}
  </Form.Control>
  <Form.Description>TODO</Form.Description>
  <Form.FieldErrors />
</Form.Field>
  ...
  <Form.Control>
    {#snippet children({ props })}
      ...
      <Input
        ...
        placeholder="Moduldauer eingeben…"
        class={$errors.duration ? 'border-destructive' : ''}
      />
    {/snippet}
  </Form.Control>
  <Form.Description>Die Anzahl an Semestern, über die sich das Modul erstreckt.</Form.Description>
  <Form.FieldErrors />
</Form.Field>
